...
public class UploadFileUtil {
	 ...
	 * @return UploadFile
	 */
	public static UploadFile getFile(MultipartFile file) {
	 ...
	 * @return UploadFile
	 */
	public static UploadFile getFile(MultipartFile file, String dir) {
	 ...
	 * @return UploadFile
	 */
	public static UploadFile getFile(MultipartFile file, String dir, String path, String virtualPath) {
		return new UploadFile(file, dir, path, virtualPath);
	}
	 ...
	 * @return UploadFile
	 */
	public static List<UploadFile> getFiles(List<MultipartFile> files) {
	 ...
	 * @return UploadFile
	 */
	public static List<UploadFile> getFiles(List<MultipartFile> files, String dir) {
	 ...
	 * @return UploadFile
	 */
	public static List<UploadFile> getFiles(List<MultipartFile> files, String dir, String path, String virtualPath) {
		List<UploadFile> list = new ArrayList<>();
		for (MultipartFile file : files) {
			list.add(new UploadFile(file, dir, path, virtualPath));
		}
		return list;
	}
