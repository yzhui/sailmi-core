...
import com.sailmi.core.boot.config.BootMybatisPlusConfiguration;
...
@Configuration
@AllArgsConstructor
@AutoConfigureBefore(BootMybatisPlusConfiguration.class)
...
public class TenantConfiguration {
	...
	public TenantHandler appTenantHandler() {
		return new  AppTenantHandler(properties);
	}
