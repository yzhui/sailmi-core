 ...
 * @since 2020-07-17
 */
public interface IBatchMessageService extends BaseService<BatchMessage> {
	 ...
	 * @return
	 */
	IPage<BatchMessageVO> selectBatchMessagePage(IPage<BatchMessageVO> page, BatchMessageVO batchMessage);
