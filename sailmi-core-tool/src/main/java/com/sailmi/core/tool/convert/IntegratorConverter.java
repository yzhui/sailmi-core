package com.sailmi.core.tool.convert;

import lombok.AllArgsConstructor;
import lombok.extern.slf4j.Slf4j;
import com.sailmi.core.tool.support.Try;
import com.sailmi.core.tool.utils.ClassUtil;
import com.sailmi.core.tool.utils.ConvertUtil;
import com.sailmi.core.tool.utils.ReflectUtil;
...
@Slf4j
@AllArgsConstructor
public class IntegratorConverter implements Converter {
	 ...
	 * @param fieldName 目标的field名，原为 set 方法名，AppBeanCopier 里做了更改
	 * @return {Object}
	 */
	@Override
	@Nullable
	public Object convert(Object value, Class target, final Object fieldName) {
		...
		try {
			TypeDescriptor targetDescriptor = IntegratorConverter.getTypeDescriptor(targetClazz, (String) fieldName);
