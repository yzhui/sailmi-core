...
import com.sailmi.core.cloud.feign.CloudFallbackFactory;
import org.springframework.lang.Nullable;

/**
 * 添加  默认的 fallbackFactory L.cm 2019.01.19
 *
 * @author L.cm
 * @author Spencer Gibb
 * @author Erik Kringen
...
public class CloudHystrixTargeter implements Targeter {
	...
	public <T> T target(FeignClientFactoryBean factory, Feign.Builder feign, FeignContext context,
		...
		return (T) builder.target(target, cloudFallbackFactory);
	}
