 ...
 */
package com.sailmi.core.cloud.hystrix;

import com.sailmi.core.cloud.props.CloudHystrixHeadersProperties;
 ...
 * @author L.cm
 */
public class CloudHttpHeadersContextHolder {
	private static final ThreadLocal<HttpHeaders> HTTP_HEADERS_HOLDER = new NamedThreadLocal<>("Sailmi hystrix HttpHeaders");

	/**
	 * 请求和转发的ip
	 */
	private static final String[] ALLOW_HEADS = new String[]{
		"X-Real-IP", "x-forwarded-for", "authorization", "sailmi-auth", "Authorization", "sailmi-auth"
	};
	...
	public static HttpHeaders toHeaders(
		@Nullable CloudHystrixAccountGetter accountGetter,
		CloudHystrixHeadersProperties properties) {
