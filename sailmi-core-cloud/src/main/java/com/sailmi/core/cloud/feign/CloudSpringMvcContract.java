...
import com.sailmi.core.cloud.annotation.ApiVersion;
import com.sailmi.core.cloud.annotation.UrlVersion;
import com.sailmi.core.cloud.version.CloudMediaType;
...
/**
 * 支持 sailmi-boot 的 版本 处理
 *
 * @see com.sailmi.core.cloud.annotation.UrlVersion
 * @see com.sailmi.core.cloud.annotation.ApiVersion
 * @author L.cm
 */
public class CloudSpringMvcContract extends SpringMvcContract {

	public CloudSpringMvcContract(List<AnnotatedParameterProcessor> annotatedParameterProcessors, ConversionService conversionService) {
	...
	protected void processAnnotationOnMethod(MethodMetadata data, Annotation methodAnnotation, Method method) {
		if (RequestMapping.class.isInstance(methodAnnotation) || methodAnnotation.annotationType().isAnnotationPresent(RequestMapping.class)) {
			...
			if (apiVersion != null && StringUtil.isNotBlank(apiVersion.value())) {
				CloudMediaType cloudMediaType = new CloudMediaType(apiVersion.value());
				data.template().header(HttpHeaders.ACCEPT, cloudMediaType.toString());
			}
		}
	}
