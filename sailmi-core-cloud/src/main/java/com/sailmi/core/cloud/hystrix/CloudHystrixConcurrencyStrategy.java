 ...
 */
@AllArgsConstructor
public class CloudHystrixConcurrencyStrategy extends HystrixConcurrencyStrategy {
	@Nullable
	...
	public <T> Callable<T> wrapCallable(Callable<T> callable) {
		Callable<T> wrapCallable = new CloudHttpHeadersCallable<>(callable, accountGetter, properties);
		return existingConcurrencyStrategy != null
