 ...
 */
package com.sailmi.core.cloud.version;
 ...
 * <p>
 *     url: /v1/user/{id}
 *     header: Accept application/vnd.sailmi.VERSION+json
 * </p>
 *
 * 注意：c 代表客户端版本
 *
...
public class CloudRequestMappingHandlerMapping extends RequestMappingHandlerMapping {
	...
	private RequestMappingInfo getApiVersionMappingInfo(Method method, Class<?> handlerType) {
		...
		// 如果url版本不存在
		if (nonUrlVersion) {
			String vsersionMediaTypes = new CloudMediaType(apiVersion.value()).toString();
