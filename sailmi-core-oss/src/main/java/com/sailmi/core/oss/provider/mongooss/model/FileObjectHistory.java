...
public class FileObjectHistory implements com.sailmi.core.oss.common.domain.model.FileObjectHistory {

    public static FileObjectHistory from(
            com.sailmi.core.oss.provider.mongooss.model.FileObject fileObjectImpl) {
