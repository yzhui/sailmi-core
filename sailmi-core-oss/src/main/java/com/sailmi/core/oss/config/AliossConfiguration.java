...
import com.sailmi.core.oss.operator.AliossOperatorImp;
...
public class AliossConfiguration {
	...
	@Bean
	@ConditionalOnMissingBean(AliossOperatorImp.class)
	@ConditionalOnBean({OSSClient.class, OssRule.class})
	public AliossOperatorImp aliossTemplate(OSSClient ossClient, OssRule ossRule) {
		return new AliossOperatorImp(ossClient,ossProperties,ossRule);
	}
