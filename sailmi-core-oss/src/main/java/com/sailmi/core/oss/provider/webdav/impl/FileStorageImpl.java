...
import com.sailmi.core.oss.provider.webdav.exception.WebDavStoreException;
import com.sailmi.core.oss.provider.webdav.support.WebDavProperties;
...
public class FileStorageImpl implements FileStorage, InitializingBean {
    ...
    private String PROVIDER_NAME = WebDavAutoConfiguration.PROVIDER_NAME;
