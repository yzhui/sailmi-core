...
import com.sailmi.core.oss.provider.qiniu.exception.QiniuStoreException;
import com.sailmi.core.oss.provider.qiniu.support.QiniuProperties;
...
public class FileStorageImpl implements FileStorage, InitializingBean {
	...
	String PROVIDER_NAME = QiniuAutoConfiguration.PROVIDER_NAME;
