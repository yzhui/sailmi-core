 ...
 */
package com.sailmi.develop.support;
...
import com.sailmi.core.tool.utils.StringUtil;
import com.sailmi.develop.constant.DevelopConstant;
...
public class DevelopCodeGenerator {
	 ...
	 * 代码所在服务名
	 */
	private String serviceName = "sailmi-service";
	/**
	 * 代码生成的包名
	 */
	private String packageName = "com.sailmi.test";
	/**
	 * 代码后端生成的地址
	 */
	 ...
	 * 需要去掉的表前缀
	 */
	private String[] tablePrefix = {"ucs_"};
	/**
	 * 需要生成的表名(两者只能取其一)
	 */
	private String[] includeTables = {"ucs_test"};
	/**
	 * 需要排除的表名(两者只能取其一)
	 */
	...
	public void run() {
		System.out.println("Now set global properties...");
		...
		System.out.println("Now set database connection...");
		...
		System.out.println("Now check database and super class...");
		if (hasSuperEntity) {
			strategy.setSuperEntityClass("com.sailmi.core.mp.base.BaseEntity");
			strategy.setSuperEntityColumns(superEntityColumns);
			strategy.setSuperServiceClass("com.sailmi.core.mp.base.BaseService");
			strategy.setSuperServiceImplClass("com.sailmi.core.mp.base.BaseServiceImpl");
		} else {
			strategy.setSuperServiceClass("com.baomidou.mybatisplus.extension.service.IService");
			strategy.setSuperServiceImplClass("com.baomidou.mybatisplus.extension.service.impl.ServiceImpl");
		}
		System.out.println("Now set controller...");
		// 自定义 controller 父类
		strategy.setSuperControllerClass("com.sailmi.core.boot.ctrl.AppController");
		strategy.setEntityBuilderModel(false);
		strategy.setEntityLombokModel(true);
		strategy.setControllerMappingHyphenStyle(true);
		mpg.setStrategy(strategy);
		System.out.println("Now set package...");
	...
	public String getOutputDir() {
		return (Func.isBlank(packageDir) ? System.getProperty("user.dir") + "/sailmi-ops/sailmi-develop" : packageDir) + "/src/main/java";
	}
