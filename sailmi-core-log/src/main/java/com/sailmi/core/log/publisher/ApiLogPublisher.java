...
package com.sailmi.core.log.publisher;

import lombok.AllArgsConstructor;
import lombok.extern.slf4j.Slf4j;
import com.sailmi.core.log.annotation.ApiLog;
import com.sailmi.core.log.constant.EventConstant;
import com.sailmi.core.log.event.ApiLogEvent;
...
public class ApiLogPublisher {
	...
	public static void publishEvent(String methodName, String methodClass, ApiLog apiLog, long time) {
		...
		logApi.setType(AppConstant.LOG_NORMAL_TYPE);
