...
package com.sailmi.core.log.utils;
...
public class LogAbstractUtil {
	 ...
	 */
	public static void addOtherInfoToLog(LogAbstract logAbstract, LaunchProperties appProperties, ServerInfo serverInfo) {
		...
		//这里判断一下params为null的情况，否则sailmi-log服务在解析该字段的时候，可能会报出NPE
