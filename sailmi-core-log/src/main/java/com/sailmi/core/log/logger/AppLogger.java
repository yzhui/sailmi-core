 ...
 */
package com.sailmi.core.log.logger;

import lombok.extern.slf4j.Slf4j;
import com.sailmi.core.log.publisher.UsualLogPublisher;
 ...
 */
@Slf4j
public class AppLogger implements InitializingBean {
	...
	public void afterPropertiesSet() throws Exception {
		log.info(serviceId + ": AppLogger init success!");
	}
